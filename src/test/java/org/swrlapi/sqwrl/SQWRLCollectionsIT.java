...
public class SQWRLCollectionsIT extends IntegrationTestBase {
  ...
  @Test
  public void TestSQWRLIndividualBagsEqual()
  ...
  @Test
  public void TestSQWRLIndividualSetsEqual()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntegerBagsEqual() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntegerSetsEqual() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  public void TestSQWRLURISetsEqual() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    ...
    SQWRLResult result = queryEngine.runSQWRLQuery("q1",
        ". sqwrl:makeSet(?s1, \"" + homePage1 + "\"^^xsd:anyURI) " + " ^ sqwrl:makeSet(?s1, \"" + homePage2
            ...
            "(?s2, \""
            + homePage2 + "\"^^xsd:anyURI) " + " ^ sqwrl:makeSet(?s2, \"" + homePage2 + "\"^^xsd:anyURI) "
            + " . sqwrl:equal(?s1, ?s2) -> sqwrl:select(0)");
  ...
  @Test
  public void TestSQWRLBagSizeWithVariables() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLSetSizeWithVariables() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntegerBagMin() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLDecimalBagMin() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLByteBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLShortBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntegerBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLLongBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLFloatBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLDoubleBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLDecimalBagMax() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagSumShortBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLSetSumShortBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagSumLongBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagSumFloatBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagAvgShortBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagAvgLongBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagAvgFloatBroadest()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntegerBagAvg() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLIntegerSetAvg() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLDecimalBagAvg() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLDecimalSetAvg() throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLBagNamedIndividualLast()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    OWLOntology ontology = OWLManager.createOWLOntologyManager().createOntology();
    SQWRLQueryEngine queryEngine = SWRLAPIFactory.createSQWRLQueryEngine(ontology);
  ...
  @Test
  public void TestSQWRLInvalidGroupByArgumentNumber()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
  ...
  @Test
  public void TestSQWRLInvalidUnboundGroupByArgument()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    this.thrown.expect(SQWRLException.class);
  ...
  @Test
  public void TestSQWRLInvalidGroupByCollectionArgument()
      throws SWRLParseException, SQWRLException, OWLOntologyCreationException {
    this.thrown.expect(SQWRLException.class);
